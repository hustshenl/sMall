...
class AuthItem extends Model
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'item_name' => Yii::t('rbac-member', 'Name'),
            'type' => Yii::t('rbac-member', 'Type'),
            'description' => Yii::t('rbac-member', 'Description'),
            'ruleName' => Yii::t('rbac-member', 'Rule Name'),
            'data' => Yii::t('rbac-member', 'Data'),
        ];
    }
