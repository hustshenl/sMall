...
$this->title = \Yii::t('member', 'Unread Histories');
$this->params['subTitle'] = $this->title;
/*$this->params['breadcrumbs']['links'] = [
    ['label' => \Yii::t('member', 'Histories'), 'url' => ['index']],
            ...
            <div class="portlet-body">
                <div class="tabbable">
                    <ul class="nav nav-tabs">
                        <li><a href="<?= \yii\helpers\Url::to(['/history']); ?>">全部记录</a></li>
                        <li class="active"><a href="javascript:void(0);">已有更新</a></li>
                    </ul>
