...
/* @var $searchModel seller\models\user\user */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('seller', 'Users');
...
$this->registerJsFile('@web/js/user.js',['depends'=>\seller\widgets\AppAsset::className()]);


$this->beginBlock('content-header-actions');
echo Html::a(Yii::t('seller', 'Create User'), ['create'], ['class' => 'btn btn-success']);
